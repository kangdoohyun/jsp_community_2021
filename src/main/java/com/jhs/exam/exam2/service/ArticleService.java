...
public class ArticleService {
	...
	public List<Article> getForPrintArticles(Member actor, int page, int itemsInAPage) {
		List<Article> articles = articleRepository.getForPrintArticles(page, itemsInAPage);
